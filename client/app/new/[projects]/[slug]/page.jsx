  ...
  return (
    <>
      <div className="dark:bg-background">
        {error !== undefined ? (
          <div className="container min-h-screen px-2 pb-10 dark:bg-background">
            <div className="grid grid-cols-1 gap-y-6 sm:gap-6 md:grid-cols-12">
              <div className="col-span-1 space-y-6 md:col-span-9">
                <div className="bg-slate-100 p-2 dark:bg-background sm:p-4">
              ...
              <div className="col-span-3 space-y-6">
                <div className="min-h-[60vh] rounded-lg bg-[#F5F5F5] p-2 dark:bg-secondary/20">
